...
public class AddTransactionAdapter extends RecyclerView.Adapter<AddTransactionAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(AddTransactionAdapter.ViewHolder holder, final int position) {
        ...
        holder.txtamount.setText(transaction.getAmount().toString());
        holder.txtDate.setText(transaction.getCreated_at());
        holder.txtPayee.setText(transaction.getPayee().toString());
        holder.txtTransactionType.setText(transaction.getCategoriesID().toString());

        holder.txtEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(mcontext,"You clicked edited",Toast.LENGTH_LONG).show();
            }
        });
        holder.txtDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(mcontext,"You clicked deleted",Toast.LENGTH_LONG).show();
            }
        });
    }
